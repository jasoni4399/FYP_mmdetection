...
class ConditionalDetrTransformerV2Decoder(DetrTransformerDecoder):
    ...
    def forward(self,
        ...
        reference_point_selection=reference_unsigmoid[...,:2].contiguous()
        ...
        query=self.content_query(coordinate_to_encoding(coord_tensor=k[...,:300, :4]+pe).sigmoid())
        ...
        for layer_id, layer in enumerate(self.layers):
            if layer_id == 0:
                ...
                pos_transformation = self.query_scale(lambda_q) #lambda_q
